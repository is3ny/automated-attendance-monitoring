...
public class TeacherActivity extends AppCompatActivity implements BeaconConsumer {
    ...
    */
    ...
    private void sendNotification() {
        ...
        stackBuilder.addNextIntent(new Intent(this, TeacherActivity.class));
        ...
        RangeNotifier rangeNotifier = new RangeNotifier() {
            ...
            public void didRangeBeaconsInRegion(Collection<Beacon> beacons, Region region) {
                ...
                if (beacons.size() > 0) {
                    ...
                    while (iter.hasNext()) {
                        List<Long> fields = iter.next().getDataFields();
                        Long[] pack = fields.toArray(new Long[0]);
                        status += StringToLongArrayPacker.toString(pack);
                        status += " ";
                    }
                    logToDisplay(status);
                }
