...
public class TeacherCourseListAdapter extends BaseAdapter {
    ...
    public TeacherCourseListAdapter(ArrayList<Course> courses, Student student, Context context){
    ...
    @Override
    public View getView(int listRow, View view, ViewGroup viewGroup) {
        if (view == null)
        ...
        for (int celli = 0; celli < attendanceStat.attendanceList.length; celli++) {
            Log.d("CourseListAdapter", String.valueOf(listRow));
